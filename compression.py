...
class VBEPostings:
    ...
    def vb_encode(list_of_numbers):
        ...
        for number in list_of_numbers:
            bytestream += VBEPostings.vb_encode_number(number)
    ...
    def encode(postings_list):
        ...
        """
        # TODO
        list_with_gap = [postings_list[0]] + [postings_list[i] - postings_list[i - 1] for i in range(1, len(postings_list))]
        return VBEPostings.vb_encode(list_with_gap)
    ...
    def decode(encoded_postings_list):
        ...
        cumulative_sum = []
        total_current = 0
        for number in decoded_postings_list:
            total_current += number
            cumulative_sum.append(total_current)
